 ...
 */
final class Version20200208123040 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE villes ADD id INT AUTO_INCREMENT NOT NULL, CHANGE ville_id ville_id INT NOT NULL, DROP PRIMARY KEY, ADD PRIMARY KEY (id)');
